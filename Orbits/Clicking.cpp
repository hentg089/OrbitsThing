...
Clicking::Clicking() : holdCount(holdCount)
{
...
//
bool Clicking::isClicking(sf::Event& event, int& holdCount /*IMPORTANT: we want to get the value from the holdCount in main, so we use '&'. Otherwise, we would have a copy of holdCount*/)
{
